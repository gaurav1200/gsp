  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      >
        ...
        <h3 className={styles.sectionHeadText} id="contact">
          Contact.
        </h3>
        <form
          ref={formRef}
        ...
        >
          <label className="flex flex-col">
            ...
            <input
              ...
              className="bg-tertiary py-4 px-6 placeholder:tex-secondary text-white rounded-lg outlined-none border-none font-medium"
            />
          </label>
          <label className="flex flex-col">
